...
export function AdminLoginPage() {
  ...
  return (
    <main className="login-page">
      <div className="login-visual"><div className="login-overlay" /><Link to="/" className="brand"><span className="brand-main">JORGE</span><span className="brand-accent">SOARES</span><span className="brand-tag">IMÓVEIS</span></Link><blockquote>“Organização nos bastidores para uma experiência impecável na frente.”</blockquote></div>
      <div className="login-panel"><div className="login-box"><span className="login-icon"><KeyRound /></span><span className="section-label">Área restrita</span><h1>Bem-vindo,<br />Jorge.</h1><p>Acesse para gerenciar seus imóveis e destaques.</p>
