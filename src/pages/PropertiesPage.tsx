    ...
    <main className="inner-page">
      ...
      <section className="list-section section-light">
        <div className="site-container">
          ...
          <div className="results-bar"><div><strong>{loading || error ? "—" : filtered.length}</strong> {loading ? "carregando imóveis" : error ? "falha ao carregar" : filtered.length === 1 ? "imóvel encontrado" : "imóveis encontrados"}</div></div>
